  ...
  return (
    <ScrollView>
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Text style={styles.modalText}>Are you sure you want to sjip this order?</Text>
            <Pressable
            ...
            <Pressable
              style={[styles.button, styles.buttonClose]}
              onPress={() =>{ alert('Change to shipped!')
              setModal1Visible(!modal1Visible)}}
            >
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Text style={styles.modalText}>Order Information</Text>
            <Card>
...
<DataTable>
      <DataTable.Header>
        ...
        <DataTable.Title >Ship</DataTable.Title>
    ...
    return(
      <>
      <DataTable.Row> 
      <DataTable.Cell>{data[id].product}</DataTable.Cell>
