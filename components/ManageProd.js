...
const DeleteData=(id)=>{
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Text style={styles.modalText}>Product Information</Text>
            <Card>
  ...
  />
      ...
      <View style={{flexDirection:'row'}}>
      <Button title="Add Product" buttonStyle={styles.button} containerStyle={styles.btnconstyle}
...
<DataTable>
    ...
    return(
      <>
      <DataTable.Row> 
      <DataTable.Cell>{data[id].title}</DataTable.Cell>
      <DataTable.Cell numeric>{data[id].Price}</DataTable.Cell>
    ...
    color={Colors.blue500}
    size={20}
    onPress={() =>navigation.navigate('Product update Form',{
      link:data[id].link,
      Unit:data[id].Unit,
      title:data[id].title,
      Ingrediant:data[id].Ingrediant,
